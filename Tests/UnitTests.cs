...
{
    [TestMethod]
    public void Subtract_Valid_Wiebe()
    {
        Assert.AreEqual(1, Program.Subtract("2", "1"));
        Assert.AreEqual(5, Program.Subtract("12", "7"));
        Assert.AreEqual(-10, Program.Subtract("20", "30"));
    }

    [TestMethod]
    public void Subtract_Invalid_Wiebe()
    {
    ...
    [TestMethod]
    public void Subtract_Null_Wiebe()
    {
...
{
    [TestMethod]
    public void Multiply_Valid_Wiebe()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Wiebe()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Wiebe()
    {
...
{
    [TestMethod]
    public void Divide_Valid_Wiebe()
    {
    ...
    [TestMethod]
    public void Divide_Invalid_Wiebe()
    {
...
public class Exponent
{
    ...
    [TestMethod]
    public void Power_Invalid_Wiebe()
    {
